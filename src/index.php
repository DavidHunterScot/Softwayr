...
<html lang="en">
    ...
    <body>
            ...
            <div class="container">
                ...
                <div class="projects">
                    <div class="project">
                        ...
                        <p><a href="https://weburl.net/staticphp" target="_blank">Visit Site</a></p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <footer>
            <div class="container">
                <p>Copyright &copy; <a href="https://weburl.net/davidhunter" target="_blank">David Hunter</a>. Powered by <a href="https://weburl.net/staticphp" target="_blank">StaticPHP</a>.</p>
            </div>
        </footer>
